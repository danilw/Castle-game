...
void main ()
{
  ...
  highp vec2 P_3;
  P_3 = (tmpvar_2 + (vec2(-3.0, -0.0) / u_resolution));
  acc_1 = (texture (u_texture1, P_3).xyz * 0.00598);
  highp vec2 P_4;
  P_4 = (tmpvar_2 + (vec2(-2.0, -0.0) / u_resolution));
  acc_1 = (acc_1 + (texture (u_texture1, P_4).xyz * 0.060626));
  highp vec2 P_5;
  P_5 = (tmpvar_2 + (vec2(-1.0, -0.0) / u_resolution));
  ...
  highp vec2 P_7;
  P_7 = (tmpvar_2 + (vec2(1.0, 0.0) / u_resolution));
  acc_1 = (acc_1 + (texture (u_texture1, P_7).xyz * 0.241843));
  highp vec2 P_8;
  P_8 = (tmpvar_2 + (vec2(2.0, 0.0) / u_resolution));
  acc_1 = (acc_1 + (texture (u_texture1, P_8).xyz * 0.060626));
  highp vec2 P_9;
  P_9 = (tmpvar_2 + (vec2(3.0, 0.0) / u_resolution));
